 ...
 * Each viewBox is trimmed to the drawn content (plus half the stroke width) so the
 * items visually rest on the floor line with no gap underneath.
 */
export default function RoomFurniture({ className }: RoomFurnitureProps) {
  return (
    <div className={`room-furniture ${className ?? ""}`} aria-hidden="true">
      <svg
        className="room-furniture__item room-furniture__item--lamp"
        viewBox="0 0 90 179"
      ...
      <svg
        className="room-furniture__item room-furniture__item--shelf"
        viewBox="0 0 130 163"
        preserveAspectRatio="xMidYMax meet"
        fill="none"
      >
      ...
      <svg
        className="room-furniture__item room-furniture__item--chair"
        viewBox="0 0 170 125"
        preserveAspectRatio="xMidYMax meet"
        fill="none"
      >
      ...
      <svg
        className="room-furniture__item room-furniture__item--table"
        viewBox="0 0 110 105"
        preserveAspectRatio="xMidYMax meet"
        fill="none"
      >
      ...
      <svg
        className="room-furniture__item room-furniture__item--plant"
        viewBox="0 0 110 163"
        preserveAspectRatio="xMidYMax meet"
        fill="none"
      >
      ...
      <svg
        className="room-furniture__item room-furniture__item--speaker"
        viewBox="0 0 90 143"
        preserveAspectRatio="xMidYMax meet"
        fill="none"
      >
